...
function Products() {
  ...
  const [page, setPage] = useState<any>(pageData || DEFAULT_PRODUCTS);

  useEffect(() => {
    // Subscribe to live products page updates
    const unsub = subscribeToPageChanges("products", (data) => {
          ...
          case "hero":
            return (
              ...
              >
                ...
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(255,122,0,0.1),transparent_60%)]" />
