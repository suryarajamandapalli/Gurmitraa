  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: "https://gurmitraa.vercel.app/about" },
...
function About() {
  ...
  const [page, setPage] = useState<any>(pageData || DEFAULT_ABOUT);

  useEffect(() => {
    // Subscribe to live about page updates
    const unsub = subscribeToPageChanges("about", (data) => {
                    ...
                    <div className="relative aspect-square rounded-[2rem] overflow-hidden bg-navy-deep">
                      ...
                      <div className="absolute inset-0 flex flex-col justify-end pb-16">
                        <div className="font-display text-white text-center px-8 z-10">
                          <div className="text-[#ff9f43] text-sm tracking-[0.4em]">EST. 2019</div>
