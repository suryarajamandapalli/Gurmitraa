  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: "https://gurmitraa.vercel.app/services" },
...
function Services() {
  ...
  const [page, setPage] = useState<any>(pageData || DEFAULT_SERVICES);

  useEffect(() => {
    // Subscribe to live services page updates
    const unsub = subscribeToPageChanges("services", (data) => {
