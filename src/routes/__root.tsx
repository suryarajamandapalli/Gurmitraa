...
import { fetchGlobalSettings, deepMerge, subscribeToGlobalChanges } from "@/lib/cms";
...
function RootComponent() {
  ...
  const [global, setGlobal] = useState<any>(globalSettings || DEFAULT_GLOBAL);
  ...
  useEffect(() => {
    // Subscribe to live global changes
